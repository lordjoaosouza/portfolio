    ...
    <>
      <div className='flex flex-col text-white justify-center items-center lg:flex-row mt-20 my-0 sm:my-40'>
        <div className='flex flex-col text-center sm:text-left w-1/2 max-w-xs sm:max-w-md justify-center items-center sm:items-start mr-0 sm:mr-10 mb-10'>
          <h1 className='flex text-xl sm:text-2xl font-bold mb-2'>Full Stack Developer</h1>
          <p className='text-lg sm:text-xl'>
            I&apos;m a passionate full-stack developer pursuing a Computer Science degree. Thriving
            on challenges and emerging technologies, I constantly seek to expand my knowledge. I
            love my work and embrace every chance to learn and grow.
          </p>
        </div>
